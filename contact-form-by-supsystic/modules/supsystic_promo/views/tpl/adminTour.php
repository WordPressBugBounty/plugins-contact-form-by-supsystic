<div id="supsystic-admin-tour" class="">
	...
	<div id="supsystic-first_edit-forms_subscribe_opts">
		<div class="supsystic-tour-content">
			...
			<p><?php printf(
     __(
       'Setup your Subscription settings here - select Subscribers destination in "Subscribe to" option - it allow to flow your subscribers not only to WordPress Users, but to other popular subscribe services. With other subscription options you will be able to easily customize your subscribe form in Form window.',
       CFS_LANG_CODE,
     ),
     CFS_WP_PLUGIN_NAME,
   ); ?></p>
	...
	<div id="supsystic-first_edit-forms_statistics_opts">
		<div class="supsystic-tour-content">
			...
			<p><?php printf(
     __(
       'After you will setup your Form - it will start displaying to your site visitors. And now - you need to check it\'s displaying statistics. Here, in Statistics tab, you will be able to see how many times Form was shown to your visitors, how many times visitors subscribed to it (if subscription is enabled), how many times visitors shared your site using Social Share Form functionality and what social networks for share is most popular (if it was enabled). If you will use AB Testing feature to increase your site popularity - you will see here all your main and tested Forms statistics - in one graph or diagramm, - and this will provide you with all required information about your Form popularity!',
       CFS_LANG_CODE,
     ),
     CFS_WP_PLUGIN_NAME,
   ); ?></p>
	...
	<div id="supsystic-first_edit-forms_code_opts">
		<div class="supsystic-tour-content">
			...
			<p><?php printf(
     __('In case you will need modify source CSS / HTML code of your Form - you can easily do this here. Just make sure that you know what you are doing - don\'t break Form. You can also find additional information about editing source code <a href="%s" target="_blank">here</a>.', CFS_LANG_CODE),
     'http://supsystic.com/edit-forms-html-css-code/',
   ); ?></p>
		</div>
		<div class="supsystic-tour-btns">
			<a href="#" class="close"><?php _e('Close', CFS_LANG_CODE); ?></a>
	...
	<div id="supsystic-first_edit-final">
		<div class="supsystic-tour-content">
			...
			<p><?php printf(
     __(
       'That\'s it! Now you know how to use our %s. Just save your Form after you will setup it - and you will see results. You can also check our site - <a href="%s" target="_blank">supsystic.com</a> to find out more about our %s plugin. If you will have any questions - you can always contact us on <a href="%s" target="_blank">WordPress plugin forum</a> or in <a href="%s" target="_blank">our support system</a>. We really hope that our solution will be helpful for you. Good luck!',
       CFS_LANG_CODE,
     ),
     CFS_WP_PLUGIN_NAME,
     $this->finishSiteLink,
     CFS_WP_PLUGIN_NAME,
     'https://wordpress.org/support/plugin/contact-form-by-supsystic',
