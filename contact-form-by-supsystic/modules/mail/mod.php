...
class mailCfs extends moduleCfs
{
  ...
  public function send($to, $subject, $message, $fromName = '', $fromEmail = '', $replyToName = '', $replyToEmail = '', $additionalHeaders = [], $additionalParameters = [])
  {
  ...
  private function _getSmtpMailer()
  {
    if (!$this->_smtpMailer) {
      ...
      $this->_smtpMailer->Debugoutput = [$this, 'pushPhpMailerError'];
  ...
  public function sendSendMailMail($to, $subject, $message, $fromName = '', $fromEmail = '', $replyToName = '', $replyToEmail = '', $additionalHeaders = [], $additionalParameters = [])
  {
  ...
  public function sendSmtpMail($to, $subject, $message, $fromName = '', $fromEmail = '', $replyToName = '', $replyToEmail = '', $additionalHeaders = [], $additionalParameters = [])
  {
    $this->_getSmtpMailer();
  ...
  public function sendWpMail($to, $subject, $message, $fromName = '', $fromEmail = '', $replyToName = '', $replyToEmail = '', $additionalHeaders = [], $additionalParameters = [])
  {
    $headersArr = [];
    $eol = "\r\n";
  ...
  public function addOptions($opts)
  {
    $opts[$this->getCode()] = [
      ...
      'opts' => [
        'mail_function_work' => ['label' => __('Mail function tested and work', CFS_LANG_CODE), 'desc' => ''],
        'notify_email' => ['label' => __('Notify Email', CFS_LANG_CODE), 'desc' => __('Email address used for all email notifications from plugin', CFS_LANG_CODE), 'html' => 'text', 'def' => get_option('admin_email')],
      ],
    ];
    return $opts;
  }
