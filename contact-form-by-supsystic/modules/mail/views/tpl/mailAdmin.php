<form id="cfsMailTestForm">
	<label>
		...
		<?php echo htmlCfs::text('test_email', ['value' => $this->testEmail]); ?>
	</label>
	<?php echo htmlCfs::hidden('mod', ['value' => 'mail']); ?>
	<?php echo htmlCfs::hidden('action', ['value' => 'testEmail']); ?>
   ...
   ?>
			<tr>
				<th scope="row" class="col-w-30perc">
					...
					<?php if (!empty($opt['changed_on'])) { ?>
						...
						<span class="description">
							<?php $opt['value'] ? printf(__('Turned On %s', CFS_LANG_CODE), dateCfs::_($opt['changed_on'])) : printf(__('Turned Off %s', CFS_LANG_CODE), dateCfs::_($opt['changed_on'])); ?>
						</span>
					<?php } ?>
				</th>
				...
				<td class="col-w-1perc">
					<?php echo htmlCfs::$htmlType('opt_values[' . $optKey . ']', ['value' => $opt['value'], 'attrs' => 'data-optkey="' . $optKey . '"']); ?>
				</td>
	...
	<?php echo htmlCfs::hidden('mod', ['value' => 'mail']); ?>
	<?php echo htmlCfs::hidden('action', ['value' => 'saveOptions']); ?>
	<button class="button button-primary">
