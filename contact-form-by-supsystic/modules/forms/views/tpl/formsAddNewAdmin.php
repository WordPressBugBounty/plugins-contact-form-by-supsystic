				...
				<div class="supsystic-bar supsystic-sticky sticky-padd-next sticky-save-width sticky-base-width-auto sticky-outer-height">
					<form id="cfsCreateFormFrm">
						<label>
							...
							<?php echo htmlCfs::text('label', ['attrs' => 'style="float: left; width: 60%;"', 'required' => true]); ?>
						</label>
						...
						<?php echo htmlCfs::hidden('action', ['value' => 'createFromTpl']); ?>
...
<div id="cfsChangeTplWnd" title="<?php _e('Change Template', CFS_LANG_CODE); ?>" style="display: none;">
	<form id="cfsChangeTplForm">
		...
		<?php echo htmlCfs::hidden('mod', ['value' => 'forms']); ?>
		<?php echo htmlCfs::hidden('action', ['value' => 'changeTpl']); ?>
		<?php echo htmlCfs::defaultNonceForAdminPanel(); ?>
	</form>
