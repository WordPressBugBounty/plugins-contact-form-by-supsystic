<table class="form-table cfsFormFieldsSettingsOptsTbl" style="width: 100%">
	<tr>
     ...
     __(
       'By default our plugin will show standard browser error messages about invalid or empty fields values. But if you need - you can replace it here. Use [label] - to set field name in your error message. For example "Please fill out [label] field". You can just leave this field empty - to use standard browser messages.',
       CFS_LANG_CODE,
     ),
   ); ?>"></i>
		</th>
		<td>
			<?php echo htmlCfs::text('params[tpl][field_error_invalid]', [
	...
	<div id="cfsFormFieldBaseSettings" class="cfsTabContent">
		<table class="form-table">
           ...
           'options' => [
			...
			<tr class="cfsFieldParamRow" data-for="rating">
				...
				<td>
					<?php echo htmlCfs::number('rate_num', [
       'value' => 5,
     ]); ?>
				</td>
			</tr>
			<tr class="cfsFieldParamRow" data-for="time">
				...
				<td>
					<?php echo htmlCfs::selectbox('time_format', [
       'options' => [
         'am_pm' => 'AM / PM',
       ...
       'value' => 'am_pm',
			...
			<tr class="cfsFieldParamRow cfsFieldFixedSelectRow" data-not-for="file,recaptcha,button,submit,reset,rating,wooattrs">
				...
				<td>
					...
					<?php echo htmlCfs::selectbox('value_preset', [
       'options' => [
       ...
       'attrs' => 'class="wnd-chosen"',
			...
			<tr class="cfsFieldsEditForCheckRadioLists cfsFieldParamRow" data-for="radiobuttons,checkboxlist">
				...
				<td>
					<?php echo htmlCfs::selectbox('display', [
       'options' => [
				...
				<td colspan="2" style="padding: 0;">
					<div id="cfsFieldsListOptsShell">
						<div id="cfsFieldListOptShellExl" class="cfsFieldListOptShell">
							...
							<?php echo htmlCfs::text('options[][name]', [
         'placeholder' => __('Name', CFS_LANG_CODE),
         'disabled' => true,
       ]); ?>
							<?php echo htmlCfs::text('options[][label]', [
         ...
         'disabled' => true,
			...
			<tr class="cfsFieldParamRow" data-for="checkbox,radiobutton,checkboxsubscribe">
				...
				<td>
					<?php echo htmlCfs::checkbox('def_checked', [
       'value' => 1,
     ]); ?>
				</td>
			</tr>
			...
			<tr class="cfsFieldParamRow" data-for="wooattrs">
				...
				<td>
					<?php echo htmlCfs::checkbox('wooattrs_mult', [
       'value' => 1,
     ]); ?>
				</td>
			</tr>
			...
			<tr class="cfsFieldParamRow" data-for="wpcategories">
				...
				<td>
					<?php echo htmlCfs::selectlist('terms', [
       'attrs' => 'class="wnd-chosen-terms" data-placeholder="' . __('Select available list', CFS_LANG_CODE) . '" style="min-width: 200px;"',
			...
			<tr class="cfsFieldParamRow" data-for="wpcategories">
				...
				<td>
					<?php echo htmlCfs::selectbox('wpcat_display', [
       'options' => [
         ...
         'checkbox' => __('Checkbox', CFS_LANG_CODE),
			...
			<tr class="cfsFieldParamRow" data-for="address">
				<th>
					...
					<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(
       __('You can use your own Google API key, check the <a href="//supsystic.com/google-maps-api-key/" target="_blank">instruction</a> how to create it. To use plugin\'s default API key leave this field blank.', CFS_LANG_CODE),
     ); ?>"></i>
				</th>
				<td>
       ...
       'value' => 1,
			...
			<tr class="cfsFieldParamRow" data-for="recaptcha">
				<th>
					...
					<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(
       sprintf(
         __('Your site key, generated on <a href="%s" target="_blank">%s</a>. To get more info - check <a href="%s" target="_blank">our tutorial.</a>', CFS_LANG_CODE),
         'https://www.google.com/recaptcha/admin#list',
         'https://www.google.com/recaptcha/admin#list',
         'http://supsystic.com/create-recaptcha-field/',
       ),
     ); ?>"></i>
				</th>
				<td>
			...
			<tr class="cfsFieldParamRow" data-for="recaptcha">
				<th>
					...
					<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(
       sprintf(
         __('Your secret key, generated on <a href="%s" target="_blank">%s</a>. To get more info - check <a href="%s" target="_blank">our tutorial.</a>', CFS_LANG_CODE),
         'https://www.google.com/recaptcha/admin#list',
         'https://www.google.com/recaptcha/admin#list',
         'http://supsystic.com/create-recaptcha-field/',
       ),
	...
	<div id="cfsFormFieldIconSettings" class="cfsTabContent">
       ...
       'attrs' => 'id="cfsFieldIconClassInp"',
			...
			<tr class="cfsFieldParamRow" data-not-for="file,recaptcha,reset,hidden">
				...
				<td>
					<?php echo htmlCfs::selectbox('icon_size', [
       'options' => [
       ...
       'attrs' => 'class="cfsProOpt"',
			...
			<tr class="cfsFieldParamRow" data-not-for="file,recaptcha,reset,hidden">
				...
				<td>
					<?php echo htmlCfs::colorpicker('icon_color', [
       'attrs' => 'class="cfsProOpt"',
     ]); ?>
				</td>
			</tr>
			<tr class="cfsFieldParamRow" data-for="rating">
				...
				<td>
					<?php echo htmlCfs::colorpicker('icon_selected_color', [
       'attrs' => 'class="cfsProOpt"',
     ]); ?>
				</td>
			</tr>
		...
		<table class="form-table">
			<tr class="cfsFieldParamRow" data-for="recaptcha">
				<th>
					...
					<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(
       sprintf(__('The color theme. You can select from themes, provided by Google, for your reCaptcha. To get more info - check <a href="%s" target="_blank">our tutorial.</a>', CFS_LANG_CODE), 'http://supsystic.com/create-recaptcha-field/'),
     ); ?>"></i>
				</th>
				<td>
					<?php echo htmlCfs::selectbox('recap-theme', [
       'options' => ['light' => __('Light', CFS_LANG_CODE), 'dark' => __('Dark', CFS_LANG_CODE)],
       'value' => 'light',
     ]); ?>
				</td>
			</tr>
			<tr class="cfsFieldParamRow" data-for="recaptcha">
				...
				<td>
					<?php echo htmlCfs::selectbox('recap-type', [
       'options' => ['audio' => __('Audio', CFS_LANG_CODE), 'image' => __('Image', CFS_LANG_CODE)],
       'value' => 'image',
     ]); ?>
				</td>
			</tr>
		...
		<table class="form-table">
			...
			<tr class="cfsFieldParamRow" data-for="text,textarea,email,url,date,time,number,file,rating">
				<th>
					...
					<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(
       __('You can modify or set here your custom patters. Edit this ONLY if you know how to modify regular expression patterns! For Files fields types you can set here file extensions, separated by comma - ",".', CFS_LANG_CODE),
     ); ?>"></i>
				</th>
				<td>
					<?php echo htmlCfs::text('vn_pattern', ['attrs' => 'style="width: 100%;"']); ?>
				</td>
			</tr>
			<tr class="cfsFieldParamRow" data-for="text,textarea,email,url,date,time,number">
				...
				<td>
					<?php echo htmlCfs::selectbox('vn_equal', ['attrs' => 'class="wnd-equal-to-chosen"']); ?>
				</td>
			</tr>
		</table>
	</div>
...
<div id="cfsFormFieldGoogleMapsWnd" style="display: none;" title="<?php _e('Select desired Map', CFS_LANG_CODE); ?>">
	<?php if ($this->isGoogleMapsAvailable) { ?>
		<?php if (!empty($this->allGoogleMapsForSelect)) { ?>
			<label><?php _e('Select Map'); ?>: <?php echo htmlCfs::selectbox('cfs_gmap_sel', [
  'options' => $this->allGoogleMapsForSelect,
  'attrs' => 'id="cfsFieldGoogleMapsSel"',
]); ?></label>
		<?php } else { ?>
			<div class="description"><p><?php printf(
     __('You have no Google Maps for now. <a href="%s" target="_blank" class="button">Create Maps</a> at first, then you will be able to select it here and past into your form', CFS_LANG_CODE),
     frameGmp::_()->getModule('options')->getTabUrl('gmap_add_new'),
   ); ?></p></div>
		<?php } ?>
	<?php } else { ?>
		<div class="description"><p><?php printf(
    ...
    admin_url('plugin-install.php?tab=search&s=Google+Maps+Easy+Supsystic'),
  ); ?></p></div>
	<?php } ?>
</div>
