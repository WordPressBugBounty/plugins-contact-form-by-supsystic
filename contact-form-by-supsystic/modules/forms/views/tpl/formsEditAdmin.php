<div id="cfsFormEditTabs">
	...
	<section>
        ...
        echo htmlCfs::hidden('params[opts_attrs][' . $optKey . ']', ['value' => $attr]);
      } ?>
					<?php } ?>
					<?php echo htmlCfs::hidden('mod', ['value' => 'forms']); ?>
					<?php echo htmlCfs::hidden('action', ['value' => 'save']); ?>
					<?php echo htmlCfs::hidden('id', ['value' => $this->form['id']]); ?>
					<?php echo htmlCfs::defaultNonceForAdminPanel(); ?>
				</form>
				<div style="clear: both;"></div>
				<div id="cfsFormPreview" style="">
					<iframe id="cfsFormPreviewFrame" name="cfsFormPreviewFrame" width="" height="" frameborder="0" src="" style=""></iframe>
...
<div style="display: none;">
	<?php _WP_Editors::editor('ololo', 'lalala'); ?>
</div>
