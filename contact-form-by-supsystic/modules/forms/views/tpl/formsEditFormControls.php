&laquo;<span id="cfsFormEditableLabelShell" title="<?php _e('Click to Edit', CFS_LANG_CODE); ?>">
	<span id="cfsFormEditableLabel"><?php echo esc_html($this->form['label']); ?></span>
	<?php echo htmlCfs::text('form_label', [
...
<span class="cfsFormShowMethodSelectionShell">
	<?php echo htmlCfs::selectbox('shortcode_example', [
   'options' => [
   ...
   'attrs' => 'class="chosen" style="width:100px;" id="cfsFormShortcodeExampleSel"',
	...
	<span class="cfsFormWhereShowBlock" data-for="shortcode">
		<?php echo htmlCfs::text('cfsCopyTextCode', [
	...
	<span class="cfsFormWhereShowBlock" data-for="membership">
		<?php if ($this->membershipPluginActive) { ?>
			<?php echo htmlCfs::selectbox('plugins[membership][enable]', [
     'options' => [
...
<div id="cfsFormSaveAsCopyWnd" style="display: none;">
	<form id="cfsFormSaveAsCopyForm">
		<label>
			...
			<?php echo htmlCfs::text('copy_label', ['value' => $this->form['label'] . ' ' . __('Copy', CFS_LANG_CODE), 'required' => true]); ?>
		</label>
		<div id="cfsFormSaveAsCopyMsg"></div>
		<?php echo htmlCfs::hidden('mod', ['value' => 'forms']); ?>
		<?php echo htmlCfs::hidden('action', ['value' => 'saveAsCopy']); ?>
		<?php echo htmlCfs::defaultNonceForAdminPanel(); ?>
		<?php echo htmlCfs::hidden('id', ['value' => $this->form['id']]); ?>
	</form>
</div>