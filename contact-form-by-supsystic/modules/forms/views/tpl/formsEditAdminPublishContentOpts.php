...
<div class="cfsFormOptRow">
	<label>
		<?php if ($this->isPro) { ?>
		<?php echo htmlCfs::checkbox('params[tpl][enb_publish]', [
    ...
    sprintf(__('Publish Content feature allows your site visitors to post content through your Contact Form. <a href="%s" target="_blank">https://supsystic.com/documentation/contact-form-publish-content/</a>', CFS_LANG_CODE), 'https://supsystic.com/documentation/contact-form-publish-content/'),
  ); ?>"></i>
	</label>
	<?php if (!$this->isPro) { ?>
	...
	<table class="form-table" style="width: 100%">
		<tr>
			...
			<td>
				<div style="width: 150px;">
					<?php echo htmlCfs::selectbox('params[tpl][pub_post_type]', [
       ...
       'attrs' => 'class="chosen chosen-responsive cfsProOpt"',
		...
		<tr>
			...
			<td>
				<div style="width: 150px;">
					<?php echo htmlCfs::selectbox('params[tpl][pub_post_status]', [
       ...
       'attrs' => 'class="chosen chosen-responsive cfsProOpt"',
		...
		<tr>
			...
			<td>
				<?php echo htmlCfs::selectlist('params[tpl][pub_post_category]', [
      'options' => $this->allCategoriesForSelect,
      'value' => isset($this->form['params']['tpl']['pub_post_category']) ? $this->form['params']['tpl']['pub_post_category'] : [],
