...
<div class="cfsFormOptRow">
	<label>
		<?php if ($this->isPro) { ?>
		<?php echo htmlCfs::checkbox('params[tpl][enb_reg]', [
    ...
    sprintf(
      __(
        'Registration form option allows you to create user registration forms and combine it with any kind of content.
You can add any field to get info and allow users to select username, password, fill out their bio, add custom user information to build a nice user profile. Also, you can select the role of the new user and set registration without confirmation. <a href="%s" target="_blank">https://supsystic.com/documentation/contact-form-registration/</a>',
        CFS_LANG_CODE,
      ),
      ' https://supsystic.com/documentation/contact-form-registration/',
    ),
  ); ?>"></i>
	</label>
	<?php if (!$this->isPro) { ?>
	...
	<table class="form-table" style="width: 100%">
		<tr>
			...
			<td>
				<div style="width: 150px;">
					<?php echo htmlCfs::selectbox('params[tpl][reg_wp_create_user_role]', [
       ...
       'attrs' => 'class="chosen chosen-responsive cfsProOpt"',
		...
		<tr>
			...
			<td>
				<?php echo htmlCfs::checkbox('params[tpl][reg_ignore_confirm]', [
