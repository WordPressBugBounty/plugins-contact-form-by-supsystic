var g_cfsFormsSubmit = {
  ...
  addSubmitOpt: function (params) {
    params = params || {};
    var $shell = jQuery(params.$shellClone ? params.$shellClone : jQuery('#cfsFormSubmitToShellEx'))
      .clone()
      .removeAttr('id');
...
jQuery(document).ready(function () {
  ...
  if (typeof cfsForm !== 'undefined' && cfsForm.params && cfsForm.params.submit && cfsForm.params.submit.length) {
    ...
    // Add at least one send option - because this is contact form in the end, right?:)
    g_cfsFormsSubmit.addSubmitOpt();
  }
