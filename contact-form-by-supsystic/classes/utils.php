...
class utilsCfs
{
  ...
  public static function createDir($path, $params = ['chmod' => null, 'httpProtect' => false])
  {
    if (@mkdir($path)) {
  ...
  {
    $ipHeaders = ['HTTP_CLIENT_IP', 'HTTP_X_REAL_IP', 'HTTP_X_SUCURI_CLIENTIP', 'HTTP_X_FORWARDED_FOR', 'REMOTE_ADDR'];
    ...
    foreach ($ipHeaders as $header) {
      ...
      $ipList = explode(',', sanitize_text_field(wp_unslash($_SERVER[$header])));
  ...
  public static function getRandStr($length = 10, $allowedChars = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890', $params = [])
  {
    $result = '';
  ...
  public static function activatePlugin()
  {
    global $wpdb;
    if (CFS_TEST_MODE) {
      add_action('activated_plugin', [frameCfs::_(), 'savePluginActivationErrors']);
    }
  ...
  public static function replaceVariables($str, $variables)
  {
    foreach ($variables as $k => $v) {
  ...
  public static function encodeArrayTxt($arr, $forceOrd = false)
  {
  ...
  public static function decodeArrayTxt($str)
  {
    $resStr = '';
  ...
  public static function getLanguages()
  {
    ...
    if (function_exists('wp_get_available_translations')) {
      // As it was included only from version 4.0.0
      $allLanguages = wp_get_available_translations();
    }
    return $allLanguages;
  }
  public static function getLanguagesForSelect()
  {
    $languagesForSelect = [];
  ...
  public static function getFaIconsList()
  {
    return [
      'fa-adjust',
      'fa-adn',
